  ...
  <ion-page>
    <ion-content :fullscreen="true">
      <div class="relative w-full h-full">
        <div class="absolute z-50 right-6 top-10">
          <div v-if="showSearchBar" class="fixed w-full left-0 px-8">
            <!--input @input="onSearch" placeholder="Test input" /-->
            <ion-searchbar
              :debounce="1000"
              v-model="searchTerm"
              class="custom"
      ...
      <div
        v-if="askPermission"
        class="fixed flex justify-center items-center left-0 top-0 w-full h-full z-[50]"
      >
